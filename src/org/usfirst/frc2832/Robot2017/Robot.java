...
>>>>>>> refs/remotes/origin/master
  //  	lights = new Lights();
    ...
    public void disabledPeriodic() {
        ...
        try {
        	SmartDashboard.putNumber("height", test.readPacket(0).Height);
			SmartDashboard.putNumber("width", test.readPacket(0).Width);
			SmartDashboard.putNumber("x", test.readPacket(0).X);
			SmartDashboard.putNumber("y", test.readPacket(0).Y);
