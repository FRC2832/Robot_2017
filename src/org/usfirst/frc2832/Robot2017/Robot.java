...
public class Robot extends IterativeRobot {
  ...
  //  	lights = new Lights();
        ...
        auto.addObject("Expel Gear Forward", "e9");
        auto.addObject("Expel Gear Sides", "e5");
        auto.addObject("SensorForward", "c4");
        auto.addObject("PixyAuton", "d4");
    ...
    public void teleopPeriodic() {
        ...
        SmartDashboard.putNumber("Pixy Voltage", pixyInput.getAverageVoltage());
