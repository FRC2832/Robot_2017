...
public class Robot extends IterativeRobot {
    ...
    public static int shootSpeeed = 710, pov;
    ...
    //public static boolean pressure = RobotMap.compressor.getPressureSwitchValue();
    ...
    public void robotInit() {
    	...
    	port = Port.kOnboard;
    	pixyCamera = new I2C(port, 63);// 42);[	b
    	pixyValue = (byte) 255;
    	buffer = new byte[1];
...
*/	    		} else {
	    			NetworkTable.getTable("").putString("c", c1.getName());  //renamed from c1 since commented out
/*	    			try {
...
*/	    		}
       ...
       // testPixy = new PixyI2C();
        ...
        //auto.addObject("Left SIDE", "z9");  // Removed this Left and Right without vision
        //auto.addObject("Right SIDE", "y9");
        auto.addObject("Center Vision", "e9");//"Expel Gear from Center (practice bot)", "e9");
        ...
        auto.addObject("Center No Sensor", "m9");
        auto.addObject("Drive forward left or right No Sensor", "l9");
        ...
        SmartDashboard.putNumber("NavX_Start_Heading", NavX.ahrs.getYaw());
