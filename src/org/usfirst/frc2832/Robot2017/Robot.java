...
import org.usfirst.frc2832.Robot2017.autonCommands.AutonomousCommand;
import org.usfirst.frc2832.Robot2017.autonCommands.DriveBackward;
...
//	    camera.setResolution(360, 240);
        ...
        */
	    ...
	    new Thread(() -> {
	    	...
	    	while(true) {
	    		if(camera == 0) {
	    			NetworkTable.getTable("camera").putString("c", c0.getName());
	    		} else {
	    			NetworkTable.getTable("camera").putString("c", c1.getName());
	    		}
	    	}
	    }).start();
       ...
       // testPixy = new PixyI2C();
        ...
        auto.addDefault("Expel Gear From left (practice bot)", "h3");
        auto.addObject("Expel Gear From left (actual bot)", "g3");
        auto.addDefault("Expel Gear From right (practice bot)", "i3");
