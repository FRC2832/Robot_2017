...
public class OI {
	...
	public JoystickButton aButton, xButton, bButton, yButton, RightBumper;
	...
	public OI() {
        ...
        SmartDashboard.putData("Shooter on", new ShooterSequenceOn());
        SmartDashboard.putData("Shooter off", new ShooterSequenceOff());
